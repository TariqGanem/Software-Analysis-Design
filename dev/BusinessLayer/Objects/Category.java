...
import DataAccessLayer.Mappers.CategoryMapper;
import DataAccessLayer.Mappers.ItemMapper;
import DataAccessLayer.Mappers.ItemSpecsMapper;
...
//        Table(){
    ...
    public Category(int type, String name, String upperCat) {
        ...
        public int getItemID(){ itemID++; return (itemID-1);  }
