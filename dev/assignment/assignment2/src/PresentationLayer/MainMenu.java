...
*/
    ...
    //checked
        private void tranferItems() {
            ...
            if(result1.isValid() && result2.isValid()) {
                ...
                if(response.equals("n")) {
                    ...
                    if (amount > 0) {
                        ...
                        else{ System.out.println("Error: No enough items to transfer!");}
                    }
                    else {
                        System.out.println("Error: Negative Number");
                    }
            ...
            else{System.out.println("Error: Category or item does not exist"); }
            }
        ...
        private void addingSubCategory() {
            ...
            if(result1.isValid()) {   	//* boolean function that returns true if it found the serial number
                ...
                if(result2.isValid()) {						//* boolean function should returns true is name has at least one letter and does not exist already
        ...
        private void makingReport() {
            ...
            if(option.equals("1")) {
                ...
                if(result1.isValid()) {
                    ...
                    else{ facade.makingDefectReport(date,desc); }
                }
                else {
                ...
                if(result2.isValid() && result3.isValid()) {   	//* boolean function that returns true if it found the serial number
                    System.out.println("Please enter Date to add in format: dd/mm/yyyy");
                    String date = scanner.nextLine();
                    System.out.println("Do you want to add description? y/n");
                    if(scanner.nextLine().equals("y")) {
                ...
                else{ facade.makingLackReport(date,desc); }
                    //* prints LackReport
        ...
        private void addingMinimumAttributeItem() {
            ...
            if(min <= 0) {
                ...
                Response result1 = facade.CheckIfExist(cname);
                Response result2 = facade.CheckIfItemExist(cname, iname);
                if(result1.isValid() && result2.isValid()) {   	//* boolean function that returns true if it found the serial number
        ...
        public void itemsTillExp(){
            ...
            if(option1.equals("y")){
                ...
                Response result1 = facade.CheckIfExist(cname);
                if(result1.isError()){
                    System.out.println("Category does not exist"); return;
                }
            }
            if(option2.equals("y")){
                System.out.println("enter item name");
                ...
                Response result2 = facade.CheckIfItemExist(cname,iname);
                if(result2.isError()){
                    System.out.println("item does not exist"); return;
                }
            }
        ...
        private boolean addingCategory() {
            ...
            if(result.isValid()) {						//* boolean function should returns true is name has at least one letter and does not exist already
            ...
            if(result1.isValid()) {
                if (scan.equals("1")) {
                    ...
                    if(discount <= 0 || discount >= 100) {
                        System.out.println("discount has to be positive and less than 100"); return;
                    }
    ...
    private void addingItem() {
        ...
        if(option.equals("2")){
            ...
            if(option2.equals("1")){
                ...
                else { System.out.println("category Name is already exists"); return; }
            }
            if(option2.equals("2") && (facade.CheckIfExist(cname).isError())){
                System.out.println("category Name does not exist"); return;
            }
            ...
            discount = scanner.nextInt();
            if(discount<0 || discount>=100){
                System.out.println("discount percentage is not valid"); return;
            }
            Response result5 = facade.addItem(iname,cname,amount,minamount,storePrice,discount,expdate,companyprice,manufacture);
        }
        else if(!option.equals("2") && !option.equals("1")){ System.out.println("Wrong input!"); }
    }

    private makeMinOrder(){
